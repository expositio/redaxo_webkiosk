...
if($func == '') {
  $list = rex_list::factory('SELECT id,name from '.$REX['TABLE_PREFIX'].'webkiosk_cats order by name');
  ...
  $form = rex_form::factory($REX['TABLE_PREFIX'].'webkiosk_cats',"Kategorien","id=".$id);
